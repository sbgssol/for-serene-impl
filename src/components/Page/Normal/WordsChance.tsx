    ...
    <>
      ...
      >
        <TypingParagraph
          paragraph={chances}
          speedInMs={50}
          className="text-md text-justify text-primaryPink-300 font-primary px-1 py-1 font-normal"
        />
      </Windows>
    </>
  );
